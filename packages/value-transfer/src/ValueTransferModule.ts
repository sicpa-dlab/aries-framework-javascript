...
import type { Transports, DependencyManager } from '@aries-framework/core'
...
export const InjectionSymbols = {
  ValueTransferService: Symbol('ValueTransferService'),
}
...
export class ValueTransferModule {
  ...
  public constructor(
    ...
    @inject(InjectionSymbols.ValueTransferService) valueTransferService: ValueTransferService,
  ...
  public async acquireWalletLock(transactionId: string) {
    return await this.valueTransferService.acquireWalletLock(transactionId)
  }
  ...
  public static register(dependencyManager: DependencyManager) {
    // Api
    dependencyManager.registerSingleton(ValueTransferModule)

    // Services
    dependencyManager.registerSingleton(InjectionSymbols.ValueTransferService, ValueTransferService)
    ...
    dependencyManager.registerSingleton(ValueTransferIssuerService)
