...
import type { ResumeValueTransferTransactionEvent } from '@aries-framework/value-transfer-events'

import { AgentConfig, EventEmitter, injectable, DependencyManager } from '@aries-framework/core'
import { InjectionSymbols } from '@aries-framework/gossip'
...
export class ValueTransferWitnessService {
  ...
  public constructor(
    ...
    this.logger = agentConfig.logger.createContextLogger('VTP-WitnessService')
    this.label = agentConfig.label
    this.valueTransferService = valueTransferService
    this.eventEmitter = eventEmitter

    this.eventEmitter.on(
      ValueTransferSharedEventTypes.ResumeTransaction,
